...
class CompanionApp:
    ...
    def _show_attached(self, parent: Any | None = None) -> bool:
        ...
        # This is an explicit global always-on-top companion.  Apply the WM
        # hint once after mapping; repeating it on every data tick causes
        # visible restacking/jumping with some window managers.
